...
if __name__ == '__main__':
    ...
    publishers = {}
    publishers['centerline'] = rospy.Publisher('/centerline', Marker, queue_size=10)
    publishers['centerline_numpy'] = rospy.Publisher('/centerline_numpy', numpy_msg(Floats), queue_size=10)
